# This document is aimed at beggining R users that start by 
# learning “tidyverse” functions. 
## It shows how some of the tasks done with “tidyverse” 
## functions have a corresponding solution using “base R” syntax 
## (using functions that are part of the core packages deployed with R).
### credit to tavareshugo.github.io
